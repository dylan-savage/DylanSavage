      ...
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          ...
          <div className="social-buttons">
            <a href="https://www.linkedin.com/in/dylan-m-savage/" aria-label="LinkedIn" className="social-button linkedin">
            ...
            <a href="https://github.com/dylan-savage" aria-label="GitHub" className="social-button github">
